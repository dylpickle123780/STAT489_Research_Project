...
source("../Simulation/GWR_simulation.R")
par(mfrow = c(2,2))
hist(bathrooms_i,main = "Bathroom simulated observations", xlab = "# Bathrooms")
hist(bedrooms_i, main = "Bedroom simulated observations", xlab = "# Bedrooms")
hist(square_feet_i, main = "Square Footage simulated observations", xlab = "Square Feet")
hist(population_i, main = "Population simulated observations", xlab = "Population")
